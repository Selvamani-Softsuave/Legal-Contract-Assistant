...
RACE_DATASET: List[Dict[str, Any]] = [
    {
        "id": "RACE-001",
    ...
    },
    {
        "id": "RACE-002",
        "category": "DIRECT_LOOKUP",
        "question": "What is the initial commitment period before termination for convenience can be exercised?",
    ...
    },
    {
        "id": "RACE-004",
        "category": "DIRECT_LOOKUP",
        "question": "What is the formal delivery method for notices under Article 11 of the Final Executed Agreement?",
    ...
    },
    {
        "id": "RACE-006",
        "category": "MULTI_HOP_DEPENDENT",
        "question": "If Acme Corp experiences a Change of Control, what is the notice requirement to terminate?",
    ...
    },
    {
        "id": "RACE-007",
        "category": "MULTI_HOP_DEPENDENT",
        "question": "Under Amendment No. 1, what was the early termination notice period and initial commitment duration?",
    ...
    },
    {
        "id": "RACE-008",
        "category": "MULTI_HOP_DEPENDENT",
        "question": "What are the combined requirements (cure period and subsequent notice window) to terminate for cause under Schedule B-2?",
    ...
    },
    {
        ...
        "question": "How did the defined Cure Period change between the Original Agreement and Amendment No. 1?",
    ...
    {
        "id": "RACE-010",
        "category": "BUDGET_STRESS_CIRCULAR",
